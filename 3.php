...
class newBase
{
     ...
     * @param string $name
     */
    //еще можно проверить число ли приходит в имя и привести к числу
     ...
     * @param mixed $value
     */
    //должно что то возращать))) в load
     ...
     * @return string
     */
    //можно было сделать  if для проверки того что приходит в value
